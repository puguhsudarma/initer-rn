...
yarn add react-native-navigation react-redux redux redux-logger redux-persist reselect rxjs redux-logic lodash @react-native-community/async-storage axios
yarn add --dev @types/react-redux @types/lodash @types/redux-logger
...
echo "Link React-Native-Navigation (https://wix.github.io/react-native-navigation/#/docs/Installing) and @react-native-community/async-storage (https://github.com/react-native-community/react-native-async-storage/blob/master/docs/Linking.md) to your android/iOS native"
